//
//  SCLWebBaseViewController.swift
//  SwiftStudy
//
...
class SCLWebBaseViewController: SCLBaseViewController {
    ...
    override func configUI() {
        ...
        webView.snp.makeConstraints{ $0.edges.equalTo(self.view) }
...
extension SCLWebBaseViewController: WKNavigationDelegate, WKUIDelegate {
